...
def xgb_model(train_x, test_x, train_y, test_y):
    xgbc = XGBClassifier(max_depth = 10,early_stopping_rounds = False,n_estimators=400,colsample_bytree = 0.8,min_child_weight = 5)
...
# def get_test_data():
#     start = time.time()
#     wb = load_workbook(r'微博测试样例数据-1113.xlsx')
#     ws = wb.get_sheet_by_name('Sheet1')
